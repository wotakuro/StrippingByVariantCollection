...
I recommend collecting and building the GraphicsStateCollection in this manner.
For the final build, enable SafeMode/StrictVarinatStripping in this tool and disable "PlayerSettings.StrictVariantStripping" for safety considerations.

※Enabling StrictVarinatStripping reduces the memory usage of unused shaders, such as fallback shaders.
</pre>